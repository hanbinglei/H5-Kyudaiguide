...
const UI = {
  zh:{
    ...
    fbFab:'反馈', fbFabTitle:'反馈与纠错', supportTitle:'这份指南帮到你了吗？', supportNote:'你的支持会直接决定接下来优先更新哪部分。', supportStar:'在 GitHub 上点个 star', supportShare:'复制链接分享给同学', supportCopied:'已复制链接', disclaimer:'本站由学生个人整理维护，非九州大学官方发布。信息力求准确并注明出处，最终请以各官方页面为准。',
  ...
  ja:{
    ...
    fbFab:'フィードバック', fbFabTitle:'ご意見・誤りの報告', supportTitle:'このガイドはお役に立ちましたか？', supportNote:'反応の多い部分から優先的に更新します。', supportStar:'GitHub でスターを付ける', supportShare:'リンクをコピーして共有', supportCopied:'リンクをコピーしました', disclaimer:'本サイトは学生個人が作成・運営するもので、九州大学の公式発行物ではありません。情報は出典を明記していますが、最終的には各公式ページをご確認ください。',
  ...
  ko:{
    ...
    fbFab:'피드백', fbFabTitle:'의견 및 오류 신고', supportTitle:'이 가이드가 도움이 되었나요?', supportNote:'반응이 많은 부분부터 우선 업데이트합니다.', supportStar:'GitHub에서 스타 누르기', supportShare:'링크를 복사해 공유하기', supportCopied:'링크를 복사했습니다', disclaimer:'이 사이트는 학생 개인이 제작·운영하는 것으로 규슈대학의 공식 발행물이 아닙니다. 정보에는 출처를 밝히고 있으나, 최종적으로는 각 공식 페이지를 확인하시기 바랍니다.',
