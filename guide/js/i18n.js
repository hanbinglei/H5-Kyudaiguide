...
const UI = {
  zh:{
    ...
    pulseVisitors:'今日 {today} 人来过 · 累计 {total} 人', pulseEvent:'距离 {name} 还有 {n} 天', pulseEventToday:'今天就是 {name}', pulseWx:'福冈 {temp}℃ · {wx}', pulseWxRain:'带伞 {p}%', pulseRead:'已看过 {n}/{total} 篇', wxClear:'晴', wxMainly:'大致晴', wxPartly:'多云', wxOvercast:'阴', wxFog:'雾', wxDrizzle:'小雨', wxRain:'雨', wxSnow:'雪', wxShowers:'阵雨', wxThunder:'雷雨',
  ...
  ja:{
    ...
    pulseVisitors:'本日 {today} 人・累計 {total} 人', pulseEvent:'{name}まであと {n} 日', pulseEventToday:'今日は {name}', pulseWx:'福岡 {temp}℃ · {wx}', pulseWxRain:'傘 {p}%', pulseRead:'{n}/{total} 記事を閲覧', wxClear:'晴れ', wxMainly:'おおむね晴れ', wxPartly:'晴れ時々くもり', wxOvercast:'くもり', wxFog:'霧', wxDrizzle:'小雨', wxRain:'雨', wxSnow:'雪', wxShowers:'にわか雨', wxThunder:'雷雨',
  ...
  ko:{
    ...
    pulseVisitors:'오늘 {today}명 · 누적 {total}명', pulseEvent:'{name}까지 {n}일', pulseEventToday:'오늘은 {name}', pulseWx:'후쿠오카 {temp}℃ · {wx}', pulseWxRain:'우산 {p}%', pulseRead:'{n}/{total}편 열람', wxClear:'맑음', wxMainly:'대체로 맑음', wxPartly:'구름 조금', wxOvercast:'흐림', wxFog:'안개', wxDrizzle:'이슬비', wxRain:'비', wxSnow:'눈', wxShowers:'소나기', wxThunder:'뇌우',
