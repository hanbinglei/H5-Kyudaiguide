...
const UI = {
  zh:{
    ...
    openLink:'打开 ›', copied:'已复制：', cleared:'已清空',
    // 村历
  ...
  ja:{
    ...
    openLink:'開く ›', copied:'コピーしました：', cleared:'クリアしました',
  ...
  en:{
    ...
    openLink:'Open ›', copied:'Copied: ', cleared:'Cleared',
  ...
  ko:{
    ...
    openLink:'열기 ›', copied:'복사됨: ', cleared:'삭제했습니다',
