...
const UI = {
  zh:{
    ...
    fbSending:'发送中…', fbSent:'已发送，谢谢！', fbSentNote:'你的反馈已直接送达维护者，不会公开。', fbFailed:'发送失败，请检查网络后重试。', fbCloseBtn:'关闭',
  ...
  ja:{
    ...
    fbSending:'送信中…', fbSent:'送信しました。ありがとうございます。', fbSentNote:'ご意見は管理者に直接届きます。公開されません。', fbFailed:'送信に失敗しました。通信環境を確認して再試行してください。', fbCloseBtn:'閉じる',
  ...
  en:{
    ...
    fbSending:'Sending…', fbSent:'Sent. Thank you!', fbSentNote:'Your message went straight to the maintainer and will not be published.', fbFailed:'Could not send. Please check your connection and try again.', fbCloseBtn:'Close',
  ...
  ko:{
    ...
    fbSending:'전송 중…', fbSent:'전송했습니다. 감사합니다!', fbSentNote:'보내주신 내용은 관리자에게만 전달되며 공개되지 않습니다.', fbFailed:'전송에 실패했습니다. 네트워크를 확인한 뒤 다시 시도해 주세요.', fbCloseBtn:'닫기',
