...
// ── 品类名（12 宫格与文章分类标签共用） ──
const CAT_I18N = {
  zh:{ '1':'入境准备','2':'在留手续','3':'租房','4':'银行·汇款','5':'手机·网络','6':'学业·奖学金','7':'打工','8':'医疗·保险','9':'交通','10':'生活贴士','11':'购物','12':'应急联系','13':'反诈安全','14':'新生特辑' },
  ja:{ '1':'入国準備','2':'在留手続き','3':'住まい探し','4':'銀行・送金','5':'携帯・ネット','6':'学業・奨学金','7':'アルバイト','8':'医療・保険','9':'交通','10':'生活のコツ','11':'買い物','12':'緊急連絡先','13':'詐欺防止','14':'新入生特集' },
  en:{ '1':'Arrival','2':'Residence','3':'Housing','4':'Banking','5':'Mobile & Net','6':'Study & Grants','7':'Part-time','8':'Medical','9':'Transport','10':'Life Tips','11':'Shopping','12':'Emergency','13':'Anti-Fraud','14':'Newcomer' },
  ko:{ '1':'입국 준비','2':'체류 수속','3':'주거','4':'은행·송금','5':'휴대폰·인터넷','6':'학업·장학금','7':'아르바이트','8':'의료·보험','9':'교통','10':'생활 팁','11':'쇼핑','12':'긴급 연락','13':'사기 방지','14':'신입생 특집' },
};
// ── UI 词典 ──
const UI = {
  zh:{
