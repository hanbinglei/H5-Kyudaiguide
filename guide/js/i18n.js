...
const UI = {
  zh:{
    ...
    nzTitle:'落地后手续办理顺序', nzSub:'三个月内需办理的手续按时间排列，可直接跳转至对应小节', skipAll:'全部主题 ↓',
    ...
    fbSending:'发送中…', fbSent:'已发送，谢谢！', fbSentNote:'感谢反馈。内容会直接送给维护者，不会公开。', fbFailed:'发送失败，请检查网络后重试。', fbCloseBtn:'关闭',
    fbFab:'反馈', fbFabTitle:'反馈与纠错', supportTitle:'这份指南帮到你了吗？', supportNote:'你的支持会直接决定接下来优先更新哪部分。', supportStar:'在 GitHub 上点个 star', supportShare:'复制链接分享给同学', supportCopied:'已复制链接', disclaimer:'本站由学生个人整理维护，非九州大学官方发布。信息力求准确并注明出处，最终请以各官方页面为准。', expNote:'本文含维护者的实地经验与判断；凡未标注出处的表述仅供参考，请以各官方页面为准。',
  starEntryArticle:'★ 这份指南有用的话，去 GitHub 给个 star',
  docTitle:'Kyudai Guide · 九大伊都 留学指南', navAria:'主导航', mapTitle:'校园地图', prevMonth:'上一月', nextMonth:'下一月',
  a11yClose:'关闭', a11yClear:'清除', a11yTop:'回到顶部', a11yArticle:'文章详情',
  ...
  ja:{
    ...
    nzTitle:'来日後の手続き順序', nzSub:'3 か月以内に必要な手続きを時系列に整理しています。タップで該当節へ移動します', skipAll:'すべてのカテゴリ ↓',
    ...
    fbSending:'送信中…', fbSent:'送信しました。ありがとうございます。', fbSentNote:'お送りいただいた内容は管理者に直接送信され、公開されません。', fbFailed:'送信に失敗しました。通信環境を確認して再試行してください。', fbCloseBtn:'閉じる',
    fbFab:'フィードバック', fbFabTitle:'ご意見・誤りの報告', supportTitle:'このガイドはお役に立ちましたか？', supportNote:'反応の多い部分から優先的に更新します。', supportStar:'GitHub でスターを付ける', supportShare:'リンクをコピーして共有', supportCopied:'リンクをコピーしました', disclaimer:'本サイトは学生個人が作成・運営するもので、九州大学の公式発行物ではありません。情報は出典を明記していますが、最終的には各公式ページをご確認ください。', expNote:'本文には運営者の実地経験に基づく記述が含まれます。出典を明記していない判断は参考情報としてお読みいただき、最終的には各公式ページをご確認ください。',
  starEntryArticle:'★ お役に立ったら GitHub でスターを',
  docTitle:'Kyudai Guide · 九大伊都 留学生ガイド', navAria:'メインナビゲーション', mapTitle:'キャンパスマップ', prevMonth:'前の月', nextMonth:'次の月',
  a11yClose:'閉じる', a11yClear:'クリア', a11yTop:'トップへ戻る', a11yArticle:'記事の詳細',
  ...
  en:{
    ...
    nzTitle:'Order of procedures after arrival', nzSub:'Procedures needed within three months, arranged chronologically; tap to jump to the relevant section', skipAll:'All categories ↓',
    ...
    fbSending:'Sending…', fbSent:'Sent. Thank you!', fbSentNote:'Your message is sent directly to the maintainer and will not be published.', fbFailed:'Could not send. Please check your connection and try again.', fbCloseBtn:'Close',
    fbFab:'Feedback', fbFabTitle:'Feedback & corrections', supportTitle:'Did this guide help you?', supportNote:'Your support decides what gets updated next.', supportStar:'Star it on GitHub', supportShare:'Copy the link and share', supportCopied:'Link copied', disclaimer:'This site is maintained by an individual student and is not an official Kyushu University publication. Sources are cited throughout; the official pages always take precedence.', expNote:'This article includes first-hand observations by the maintainer. Statements without a cited source are for reference only; the official pages always take precedence.',
  starEntryArticle:'★ Found this useful? Star it on GitHub',
  docTitle:'Kyudai Guide · Kyushu U, Ito Campus', navAria:'Main navigation', mapTitle:'Campus map', prevMonth:'Previous month', nextMonth:'Next month',
  a11yClose:'Close', a11yClear:'Clear', a11yTop:'Back to top', a11yArticle:'Article',
  ...
  ko:{
    ...
    nzTitle:'입국 후 수속 순서', nzSub:'3개월 이내에 필요한 수속을 시간순으로 정리했습니다. 탭하면 해당 절로 이동합니다', skipAll:'전체 카테고리 ↓',
    ...
    fbSending:'전송 중…', fbSent:'전송했습니다. 감사합니다!', fbSentNote:'보내주신 내용은 관리자에게 직접 전달되며 공개되지 않습니다.', fbFailed:'전송에 실패했습니다. 네트워크를 확인한 뒤 다시 시도해 주세요.', fbCloseBtn:'닫기',
    fbFab:'피드백', fbFabTitle:'의견 및 오류 신고', supportTitle:'이 가이드가 도움이 되었나요?', supportNote:'반응이 많은 부분부터 우선 업데이트합니다.', supportStar:'GitHub에서 스타 누르기', supportShare:'링크를 복사해 공유하기', supportCopied:'링크를 복사했습니다', disclaimer:'이 사이트는 학생 개인이 제작·운영하는 것으로 규슈대학의 공식 발행물이 아닙니다. 정보에는 출처를 밝히고 있으나, 최종적으로는 각 공식 페이지를 확인하시기 바랍니다.', expNote:'이 글에는 운영자의 현지 경험에 기반한 서술이 포함되어 있습니다. 출처를 밝히지 않은 판단은 참고용으로 읽으시고, 최종적으로는 각 공식 페이지를 확인하시기 바랍니다.',
  starEntryArticle:'★ 도움이 되었다면 GitHub에서 스타를',
  docTitle:'Kyudai Guide · 규슈대 이토 캠퍼스', navAria:'주요 메뉴', mapTitle:'캠퍼스 지도', prevMonth:'이전 달', nextMonth:'다음 달',
  a11yClose:'닫기', a11yClear:'지우기', a11yTop:'맨 위로', a11yArticle:'글 상세',
