...
const UI = {
  zh:{
    ...
    fbFab:'反馈', fbFabTitle:'反馈与纠错', supportTitle:'这份指南帮到你了吗？', supportNote:'你的支持会直接决定接下来优先更新哪部分。', supportStar:'在 GitHub 上点个 star', supportShare:'复制链接分享给同学', supportCopied:'已复制链接',
  ...
  ja:{
    ...
    fbFab:'フィードバック', fbFabTitle:'ご意見・誤りの報告', supportTitle:'このガイドはお役に立ちましたか？', supportNote:'反応の多い部分から優先的に更新します。', supportStar:'GitHub でスターを付ける', supportShare:'リンクをコピーして共有', supportCopied:'リンクをコピーしました',
  ...
  en:{
    ...
    fbFab:'Feedback', fbFabTitle:'Feedback & corrections', supportTitle:'Did this guide help you?', supportNote:'Your support decides what gets updated next.', supportStar:'Star it on GitHub', supportShare:'Copy the link and share', supportCopied:'Link copied',
  ...
  ko:{
    ...
    fbFab:'피드백', fbFabTitle:'의견 및 오류 신고', supportTitle:'이 가이드가 도움이 되었나요?', supportNote:'반응이 많은 부분부터 우선 업데이트합니다.', supportStar:'GitHub에서 스타 누르기', supportShare:'링크를 복사해 공유하기', supportCopied:'링크를 복사했습니다',
