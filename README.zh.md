...
**在线**（开启 GitHub Pages 后）：
- 🗺️ 地图 — `https://hanbinglei.github.io/H5-Kyudaiguide/h5-mvp/app.html`
- 📖 指南 — `https://hanbinglei.github.io/H5-Kyudaiguide/guide/`
...
- **指南** —— 12 场景生活指南（入境准备、在留手续、租房、银行、SIM 卡、奖学金、
